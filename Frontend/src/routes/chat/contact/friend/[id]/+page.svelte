<script>
    ...
    import { getUserInfo, getUserFriendOnline, getUserSelectedInfo, sendInvitation, checkFriend, acceptInvitation, rejectInvitation, sendMessage, getMessage, deleteFriend } from "../../../../../lib/auth";
